...
st.markdown("""
<style>
    h1 {color: #1e88e5; text-align: center; font-size: 48px; margin-bottom: 10px;}
    .subtitle {text-align: center; font-size: 22px; color: #555; margin-bottom: 80px;}
    .uploader-container {max-width: 700px; margin: auto;}
</style>
